...
class IPADump(object):
    ...
    def __init__(self, device, app, present_path, output=None, verbose=False, keep_watch=False, skip_plugins=False):
        self.device = device
        self.app = app
    ...
    def load_agent(self):
        agent = os.path.join(self.present_path + '/agent', 'dist.js')
...
def main():
    ...
    task = IPADump(dev, app, args.path,
